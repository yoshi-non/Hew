...
//質問に対する回答のis_best_answer=1の質問情報を取得する
$questions = $db->query('
  SELECT questions.body,questions.id, questions.created_at, members.name, members.picture
  FROM questions
  JOIN members ON questions.member_id = members.id
  JOIN answers ON questions.id = answers.question_id
  WHERE answers.is_best_answer = 1
        ...
        <div class="qa__box">
          <div class="qa__nav">
            <ul>
              ...
              <li class="qa__open"><a href="qa__fin.php">解決済</a></li>
