...
<head>
    <meta charset="UTF-8">
    <title>Hew Sign-Up_FinPage</title>
...
<body>
    ...
    <div id="wrap__signUp" class="wrap__fin">
      <div class="check_mark_icon"><img src="../../images/check_mark_icon.png"></div>
      <p class="signUp__fin">Registration Successful!</p>
      <!-- <div class="signUp__back"></div> -->
      <div class="signUp__go" style="width: 100%; text-align: center;"><a href="../login.php">Top Page</a></div>
    </div>
